...
function setUserData(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(0, commands_1.isCommand)(req.body))
                        return [2 /*return*/, res
                                .send("Incorrect object - ".concat(JSON.stringify(req.body), " details: ").concat(JSON.stringify(commands_1.isCommand.errors)))
                                .status(400)];
                    response = {
                        valid: false,
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, commands_1.CommandModel.getLastDocumentFromUser(data.userId)];
            case 1:
                lastRecord = _a.sent();
