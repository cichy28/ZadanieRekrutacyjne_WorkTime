...
var DataParser = /** @class */ (function () {
    ...
    DataParser.prototype.splitArrayToArrayOfArrays = function (array, numberOfElementsInArray) {
        ...
        var resultArray = [];
        for (var index = 0; index < array.length - numberOfElementsInArray; index += numberOfElementsInArray) {
            var resultArray2 = [];
            for (var index2 = index; index2 < index + numberOfElementsInArray; index2++) {
